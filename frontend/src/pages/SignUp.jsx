      ...
      <div className={`w-full max-w-md p-8 space-y-8 rounded-xl shadow-lg ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
        <div className="text-center">
          ...
          <p className={`mt-2 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
            Or <a href="/login" className="font-medium text-blue-500 hover:text-blue-400">sign in to your existing account</a>
          </p>
        </div>
        
        <form className="space-y-6">
          <div>
            <label htmlFor="name" className={`text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Full Name</label>
            <input 
              id="name"
              name="name"
              type="text" 
